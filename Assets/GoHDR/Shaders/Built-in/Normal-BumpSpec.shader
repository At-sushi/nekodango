...
//			return goHDRLightWeight;

//			return ( GoHDRApplyCorrection( c  ) );
			
			return LLEncodeGamma( GoHDRApplyCorrection( c ) );
//			return fixed4( LLEncodeGamma( GoHDRApplyCorrection( c.rgb ) ), c.a);
